...
router.post('/', function(req, res, next) {
  ...
  pg.connect(connection, function(err, client, done) {
    // var queryText = "UPDATE dares SET dare_status = NULL, video_link = NULL WHERE id = ";
    // queryText = queryText + updateDare.id;

    var queryText = "UPDATE dares SET dare_status = NULL, video_link = NULL, status_change_timestamp = '";
